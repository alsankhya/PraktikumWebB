...
<body>
    ...
    <div id="sectionHome">
        <h1 style="padding-top: 300px;">Selamat Datang di Perpustakaan Jimbaran, <?php echo $_SESSION['nama']; ?></h1>
            ...
            <div class="row">
                <div class="col-md-5 offset-md-1">
                    <div class="halign-center">
                        <h2 class="text-right font-weight-bold">Apa itu Perpustakaan Jimbaran?</h2>
    ...
    <div id="form-peminjaman">
        ...
        <table>
            ...
            <td><input type="text" id="judul" name="judul" placeholder="Judul Buku Lengkap"></td>
            </tr>
            <tr>
            <td>Kode Buku yang Dipinjam</td>
            <td><input type="text" id="kode" name="kode" placeholder="contoh: BK02"></td>
            </tr>
            <tr>
...
<footer class="page-footer font-small blue pt-4">
  ...
  <div class="container-fluid text-center text-md-left">
    ...
    <div class="row">
      ...
      <div class="col-md-6 mt-md-0 mt-3">
        ...
        <!-- Content -->
        <h5 class="text-uppercase">Perpustakaan Jimbaran </h5>
      </div>
      <!-- Grid column -->
  ...
  <div class="footer-copyright text-center py-3">© 2020 Copyright:
    <a href="https://mdbootstrap.com/" style="color: black;"> Perpustakaan Jimbaran</a>
  </div>
  <!-- Copyright -->
